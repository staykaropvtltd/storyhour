...
export default function SiteFooter() {
  ...
  return (
    <footer id="footer" className="relative w-full overflow-hidden select-none antialiased">
      {/* ─── Top Organic Storybook Cloud Wave (Soft Transition from #FAF6EE into Cerulean Sky) ─── */}
      <div className="w-full overflow-hidden leading-none -mb-[1px] bg-[#FAF6EE] pointer-events-none select-none">
        <svg
          viewBox="0 0 1440 50"
          fill="none"
          preserveAspectRatio="none"
          className="w-full h-6 sm:h-9 md:h-11 text-[#2d88f6]"
          aria-hidden="true"
        >
          {/* Gentle storybook cloud wave crest */}
          <path
            d="M0,30 C200,8 380,40 560,18 C740,-4 920,38 1100,16 C1260,-4 1360,26 1440,20 L1440,50 L0,50 Z"
            fill="#2d88f6"
          />
        </svg>
      </div>
        ...
        <div className="relative max-w-[1360px] mx-auto px-6 sm:px-10 z-10 flex flex-col items-center">
          ...
          */}
          ...
          {/* 
            ...
            Center/Right: 3 spacious columns of white navigation links with butterflies
          */}
            ...
            <div className="lg:col-span-4 flex flex-col items-start">
              ...
              <div className="mb-3 sm:mb-4">
                <Link href="/" className="inline-block transition-transform duration-200 hover:scale-105" aria-label="StoryHour Homepage">
                  <div
                    className="relative h-11 w-40 sm:h-12 sm:w-44 bg-white/95 backdrop-blur-sm rounded-2xl px-3.5 py-1.5 flex items-center justify-center border-2 border-white/80 shadow-[0_4px_16px_rgba(0,0,0,0.08)]"
                    style={{ maxWidth: "180px", maxHeight: "52px" }}
                  >
                    <Image
